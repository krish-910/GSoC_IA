...
# Preprocess the data and extract persons
...
# Get the top 50 most frequently occurring person
    ...
    with open(output_file, 'w', encoding='utf-8') as output_file:
        ...
        for doc_index, doc in enumerate(preprocessed_data):
          if doc_index < len(Document_Titles):
            ...
            if any(person in doc_entities['PERSON'] for person in top_50_persons):
                data_row = f'{pdf_url}\t'
